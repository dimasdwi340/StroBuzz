...
public class rekomendasi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(rekomendasi.this, suhu.class);
                startActivity(i);
            }
        });
                        ...
                        new OnCompleteListener<Location>() {
                            ...
                            public void onComplete(@NonNull Task<Location> task) {
                                ...
                                if (location == null) {
                                    ...
                                    temp_lon=location.getLongitude();
                                    latTextView.setText(Double.toString(temp_lat));
                                    lonTextView.setText(Double.toString(temp_lon));
                                }
                            }
                        }
                );
    ...
    private LocationCallback mLocationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            latTextView.setText((int) mLastLocation.getLatitude());
            lonTextView.setText((int) mLastLocation.getLongitude());
        }
    };
